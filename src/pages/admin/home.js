...
export default function Dashboard() {
  ...
  const fetchOrders = async () => {
    try {
      const res = await fetch('/api/admin/payment'); // fetch all orders
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{
              ...
              color: '#b0b0b0',
              margin: 0
            }}>Monitor and manage all orders</p>
          </div>
          <button
            onClick={() => router.back()}
            style={{
        ...
        <div style={{
          ...
          <div style={{ flex: 1 }}>
            <p style={{
              ...
              Payments are processed through your payment gateway. 
